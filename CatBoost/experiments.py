...
This script used to train and evaluate a predictive model.
...
for dataset_name in datasets:
    ...
    for bucket in set(bucket_assignments_test):
        ...
        if cls_method=='catboost' and bucket_method!='cluster':
            ...
            pd.DataFrame(dt_train_bucket_encoded).to_csv(dataset_name+cls_method+"dt_train_bucket_encoded.csv", sep=";",
                                                  index=False)
            del dt_train_bucket_encoded
            pd.DataFrame(dt_test_bucket_encoded).to_csv(dataset_name+cls_method+"dt_test_bucket_encoded.csv", sep=";",
                                                         index=False)
            ...
            cls.fit(dt_train_bucket_encoded, train_y, list(dt_train_bucket_encoded.select_dtypes(include=['object', 'category']).columns))
