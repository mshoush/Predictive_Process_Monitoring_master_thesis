...
This script used to tune model and select the best hyper-parameters for each classification model.

"tp run this script:"
        python experiments_optimize_params.py <data set> <bucketing_encoding> <classifier> <nr_iteration>
        python experiments_optimize_params.py <data set> <prefix_index_nrEvents> <classifier> <nr_iteration>

        Ex:
            python experiments_optimize_params.py production single_laststate  catboost 10
            python experiments_optimize_params.py production prefix_index_10  catboost 10
