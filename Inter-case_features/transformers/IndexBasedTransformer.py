...
class IndexBasedTransformer(TransformerMixin):
    ...
    def __init__(self,bucket,cls_method, case_id_col, cat_cols, num_cols, max_events=None, fillna=True, create_dummies=True):
    ...
    def transform(self, X, y=None):
        ...
        if self.cls_method == 'catboost':
            self.create_dummies = False
