...
# inter_Production_past_ongoing_cr_intensity
case_id_col[dataset] = "Case ID"
activity_col[dataset] = "Activity"
resource_col[dataset] = "Resource"
timestamp_col[dataset] = "Complete Timestamp"
...
dynamic_num_cols[dataset] = ['comment_before_12month', 'actors',
                             'commits_by_commiters_before3m', 'commits_by_commenters_nunique', 'ev_assigned',
                             'ev_labeled',
...
static_num_cols[dataset] = ['lbl_bug', 'lbl_documentation', 'lbl_duplicate', 'lbl_enhancement', 'lbl_feature',
                            ...
                            'lbl_wontfix', 'created_before3m', 'closed_before3m', 'commit_before3m',
