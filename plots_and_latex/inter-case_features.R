...
# actual data
data_fscore <- read.csv("./final_data/nemenyi/Inter_fscore_data_catboost_nemenyi.csv", sep=";", header=T)
...
data <- read.csv("./final_data/nemenyi/Inter_data_catboost_nemenyi.csv", sep=";", header=T)
...
png("./images_cd/inter/cd_classifiers_nodupli.png", width=1000, height=500)
plotCD (dt_best_cast, alpha=0.05, cex=2)
dev.off()
pdf("./images_cd/inter/rplot_cd_classifiers.pdf", width=100, height=40) 
...
png("./images_cd/inter/cd_catboost.png", width=1000, height=500)
plotCD (dt_xgb_cast, alpha=0.05, cex=1.25)
dev.off()
pdf("./images_cd/inter/rplot_cd_catboost.pdf", width=100, height=40) 
...
png("images_cd/inter/cd_all.png", width=2000, height=900)
plotCD (data_cast, alpha=0.05, cex=0.8)
dev.off()
pdf("./images_cd/inter/rplot_cd_all.pdf", width=500, height=90) 
