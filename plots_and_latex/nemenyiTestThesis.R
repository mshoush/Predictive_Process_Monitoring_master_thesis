...
# actual data
data_fscore <- read.csv("./final_data/nemenyi/data_catboost_fscore_nemenyi.csv", sep=";", header=T)
...
#data <- read.csv("all_mean_aucs.csv", sep=";", header=T)
data <- read.csv("./final_data/nemenyi/data_catboost_nemenyi.csv", sep=";", header=T)
data
...
png("./images_cd/catboost/cd_classifiers.png", width=1000, height=500)
plotCD (dt_best_cast, alpha=0.05, cex=2)
dev.off()
...
png("./images_cd/catboost/cd_catboost.png", width=1000, height=500)
...
png("./images_cd/catboost/cd_xgboost.png", width=1000, height=500)
plotCD (dt_xgb_cast, alpha=0.05, cex=1.25)
dev.off()
...
png("images_cd/catboost/cd_all.png", width=2000, height=900)
